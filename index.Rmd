...
```
Intepretacion:
No existe evidencia estadistica para afirmar que la correlacion es significativa.
...
```{r}
SCR <- (0.281^2)*var(edad)*(200-1);SCR
SCT <- var(gastos)*(200-1);SCT
SCE <- var(gastos)*(200-1)-(0.281^2)*var(edad)*(200-1);SCE #2
```
